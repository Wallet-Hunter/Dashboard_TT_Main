...
const StackedBar1 = () => {
    ...
    return (
        <div style={{ width: '100%', height: '300px', position: 'relative', padding: '20px', boxSizing: 'border-box' }}>
            <div style={{ width: '100%', height: '65%', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', marginTop: '20px' }}>
