...
import LineChart from "./cmscharts/Group/LineChart1";
import HeatMap from "./cmscharts/Group/HeatMap";
import PieChart from "./cmscharts/Group/DoughnutChart";
...
const GroupBasedAnalyticsGraph = ({
  ...
  return (
    <Box sx={{ display: "flex", height: "100%", padding: 3 }}>
      {/* Left side with charts in a 2x2 grid */}
      <Box sx={{ width: "60%", display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 2 }}>
        {/* Bar Chart */}
        <Card sx={{ height: "200px", width: "95%", display: "flex", justifyContent: "center", alignItems: "center", transition: "box-shadow 0.3s ease-in-out", "&:hover": { boxShadow: `0px 4px 20px 0px #54d5d9` } }}>
